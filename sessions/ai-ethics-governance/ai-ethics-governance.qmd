...
/* ============ book shelf (typographic covers, not reproductions) ============ */
.shelf{display:grid;grid-template-columns:repeat(3,1fr);gap:1.4em;margin:.5em 0 .3em;align-items:start}
.bk .cover{height:9.4em;border-radius:3px;padding:.85em .8em;display:flex;flex-direction:column;
  justify-content:space-between;color:#fff;box-shadow:0 3px 12px rgba(0,0,0,.22)}
.bk .cover .t{font-size:.85em;font-weight:900;line-height:1.15;letter-spacing:-.01em}
.bk .cover .a{font-size:.6em;font-weight:700;opacity:.92;line-height:1.3}
...
<div class="shelf">
  <div class="bk">
    <div class="cover" style="background:#7D3C98"><span class="t">Data Feminism</span><span class="a">Catherine D&rsquo;Ignazio<br>&amp; Lauren F. Klein &middot; 2020</span></div>
    <div class="why">Who counts, who does the counting, and who is missing.</div>
  </div>
  <div class="bk">
    <div class="cover" style="background:#1C618C"><span class="t">Algorithms of Oppression</span><span class="a">Safiya Umoja Noble &middot; 2018</span></div>
    <div class="why">Retrieval is not neutral.</div>
  </div>
  <div class="bk">
    <div class="cover" style="background:#1E8F5B"><span class="t">Automating Inequality</span><span class="a">Virginia Eubanks &middot; 2018</span></div>
    <div class="why">What automated eligibility and targeting systems do to poor people.</div>
  </div>
</div>
```
