...
r_wb_verify <- "Command to verify installation: `R.exe --version` -> expected output if already installed: `R version 4.*.* [...]` followed by R's copyright information"
...
3. Then verify that R is available in the command line. `r r_wb_verify`
